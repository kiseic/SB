...
#        matplotlib.pyplot.savefig(args.filename+'.svg', transparent=True, bbox_inches='tight')
        matplotlib.pyplot.savefig(args.filename+'.png', transparent=True, bbox_inches='tight')
    else:
