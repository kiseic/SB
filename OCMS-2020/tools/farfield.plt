...
set xtics 0.00000,60 norangelimit
set ytics autofreq  norangelimit

set title "" 

set xlabel "Far-field angle theta [deg]" 
set xrange [ 0.00000 : 360.000 ] noreverse nowriteback

set ylabel "Intensity [arb. units]" 
set yrange [ * : * ] noreverse nowriteback

plot "dat.farfield" w lp lc "red"
